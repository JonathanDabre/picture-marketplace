...
const Banner = ({user, handleCreateClick, handleExploreClick}) => {
  return (
    <div className="banner px-10 pt-5 pb-20">
        ...
        <div className="text-[#8E8E8E] font-normal text-xl mb-6">Welcome {user} Explore on the world's best & largest NFT marketplace</div>
